...
{
    public class FJ2Output : EntityDto
    {
        /// <summary>
        /// 项目名称
        /// </summary>
        ...
        /// 是否签订文勘协议
        /// </summary>
        public bool IfSignSurveyAgreement { get; set; }
        ...
        /// 是否具备考古勘探入场条件
        /// </summary>
        public bool IfHaveTheConditionsForSurvey { get; set; }
        ...
        /// 是否转入考古发掘
        /// </summary>
        public bool IfExcavation { get; set; }
        ...
        /// 完毕业务意见书-是否领取
        /// </summary>
        public bool ReceivedWorkFinishInfoDocument { get; set; }
        ...
        /// 完毕通知书-是否领取
        /// </summary>
        public bool ReceivedFinishDocument { get; set; }
